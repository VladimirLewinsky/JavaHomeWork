...
public class h5 {
    ...
    public static void main(String[] args) {
        ...
        long hashmaptime = hashmaptimeend-hashmaptimestart;
        long treemaptime = treemaptimeend-treemaptimestart;

        int x = 5;
        System.out.println(hashmaptime);
        System.out.println(treemaptime);
        
        System.out.println(hashmaptime > treemaptime);
        System.out.println(hashmaptime == treemaptime);
        System.out.println(hashmaptime < treemaptime);
